...
public class Probability {
	...
	public static int run(Configuration conf) throws Exception {
		total = conf.getInt("TOTALWORDS", 0);// 先读取单词总类别数
	...
	static class ProbMapper extends Mapper<LongWritable, Text, Text, DoubleWritable> {
		...
		private static DoubleWritable number = new DoubleWritable();// 每个单词的概率
		private static Text className = new Text();//类别名
